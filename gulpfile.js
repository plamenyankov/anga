...
elixir(function(mix) {
 ...
 //mix.copy('node_modules/foundation-sites/dist/foundation.js',elixir.config.publicPath+'/js/foundation.js');
 ...
 //mix.copy('node_modules/fullpage.js/jquery.fullPage.scss',elixir.config.publicPath+'/sass/jquery.fullPage.scss');
 //mix.copy('node_modules/fullpage.js/vendors/jquery.easings.min.js',elixir.config.publicPath+'/js/easings.js');
 //mix.copy('node_modules/fullpage.js/vendors/jquery.slimscroll.min.js',elixir.config.publicPath+'/js/slimscroll.js');
 //mix.copy('node_modules/fullpage.js/jquery.fullPage.js',elixir.config.publicPath+'/js/fullPage.js');
